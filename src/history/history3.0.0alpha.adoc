...
* 階段先に行き止まりが生成されるようになったエンバグを修正 (link:https://osdn.net/projects/hengband/ticket/39748[#39748] 参照)
* 追加モンスターの性質上闘技場の戦闘力計算でゼロ除算が発生する不具合 (link:https://osdn.net/projects/hengband/ticket/39526[#39526] 参照)
* Linux版の警告修正 (link:https://osdn.net/projects/hengband/ticket/39586[#39586] 参照)
