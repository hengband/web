...
* 現在開発中の3.0.0Alpha15は4/4リリース予定です。進捗内容の確認はlink:https://github.com/hengband/hengband/issues?q=milestone%3A%223.0.0Alpha15Release%22[マイルストーン]にてご確認下さい。
...
Alpha版定期更新として3.0.0Alpha14をリリースしました。元素使いは引き続き試験中です。
