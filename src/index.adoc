...
* 現在開発中の3.0.0Alpha43は10/31リリース予定です。進捗内容の確認はlink:https://github.com/hengband/hengband/milestone/41[マイルストーン]にてご確認下さい。
...
* link:https://github.com/hengband/hengband/releases/download/3.0.0Alpha42/Hengband-3.0.0Alpha42-jp.zip[3.0.0Alpha42 Windows(日本語版)]
* link:https://github.com/hengband/hengband/releases/download/3.0.0Alpha42/Hengband-3.0.0Alpha42-en.zip[3.0.0Alpha42 Windows(English Version)]
* link:https://github.com/hengband/hengband/archive/3.0.0Alpha42.zip[ソース(zip)]
* link:https://github.com/hengband/hengband/archive/3.0.0Alpha42.tar.gz[ソース(tar.gz)]
